...
1. There is only one catch option available to choose from:
  1. F<sub>MSY</sub> × SSB<sub>2022</sub> / MSY B<sub>trigger</sub>
...
### **Features added in 2020:**

-	Table added indicating the number of vessels by gear used in the tool to raise the catch allocations.A document (ICES, 2020) with an analysis on how the vessels numbers were derived is available in the useful links tab (analysis updated using 2020 data).
...
Selectivity for each of the gear aggregations was updated using data from 2019-2020. However, due to sampling limitations in the seine fleet the selectivity curve for was not updated. The selectivity for the seine fleet was derived using data from 2016-2018.   
